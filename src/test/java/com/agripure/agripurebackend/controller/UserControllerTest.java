...
public class UserControllerTest {
    ...
    void setUp() {
        ...
        userList.add(new User(1L, "admin123", "example123@gmail.com", "admin123", true));
        userList.add(new User(2L, "admin456", "example456@gmail.com", "admin456", false));
        userList.add(new User(3L, "admin789", "example789@gmail.com", "admin789", false));
        userList.add(new User(4L, "admin000", "example000@gmail.com", "admin000", true));
    }
    ...
    void insertUserTest() throws Exception {
        User user = new User(100L, "admin", "example@gmail.com", "admin", false);
